...
public class Cliente implements Serializable {
    ...
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "codCliente")
    private Collection<Albaran> albaranCollection;
    ...
    public Cliente(Integer codCliente, String nombre, String apellido1, String apellido2, String direccion, int codigoPostal, String municipio, int telefono, String email, boolean estado) {
        this.codCliente = codCliente;
        this.nombre = nombre;
    ...
    @XmlTransient
    public Collection<Albaran> getAlbaranCollection() {
        return albaranCollection;
    }

    public void setAlbaranCollection(Collection<Albaran> albaranCollection) {
        this.albaranCollection = albaranCollection;
    }
